    ...
    <Container maxWidth={false} sx={{ display: "flex" }}>
      ...
      >
        <Box className="popup-watchlist" sx={{ display: "flex" }}>
          ...
          {open ? (
            <Box sx={{ mt: 4 }}>
              <Typography sx={{ backgroundColor: "beige", p: 1 }}>
                Refers to the list of all stocks that are bought by the user
                along with other details like quantity, price.
              </Typography>
            </Box>
          ) : null}
        </Box>
            ...
            {dummyStocks.map((stock) => (
              <Grid item xs={12} key={stock.id}>
                ...
                >
                  ...
                  >
                    <Box>
                      <Typography variant="h6">
                        Qty.<strong>{stock.qty}</strong>&nbsp;&nbsp;Avg.
                        <strong>{stock.avgPrice}</strong>
                      </Typography>
                    </Box>
                    <Box>
                  ...
                  >
                    <Typography variant="h6">
                      Invested <strong>{stock.invested}</strong>
                    </Typography>
                    <Typography variant="h6">
